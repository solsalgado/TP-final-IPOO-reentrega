        ...
        switch ($opcion) {
            ...
            case 3: // Eliminar empresa
                ...
                if ($existeEmpresa == true) {
                    ...
                    for ($i=0; $i < $c; $i++) { 
                        ...
                        $empresaDelViaje = $unViaje->getObjEmpresa();
            ...
            case 6: // Eliminar responsable
                ...
                if ($existeResponsable == true) {
                    ...
                    for ($i=0; $i < $c; $i++) { 
                        $unViaje =$listarViajes[$i];
                        $responsableDelViaje = $unViaje->getObjResponsable();
                    ...
                    if ($responsableOcupado == 0) {
                        ...
                        echo "\nEl responsable tiene asignado un viaje, no se puede eliminar.\n";
                        echo "★-------------------------------------★". "\n";
                    }
            ...
            case 9: // Eliminar viaje
                ...
                if ($existeViaje == true) {
                    ...
                    for ($i=0; $i < $c; $i++) { 
                        ...
                        $viajePasajero = $unPasajero->getObjViaje();
                ...
                if ($buscarViaje) {
                    ...
                    if ($c > 0) {
                        ...
                        for ($i=0; $i < $c; $i++) { 
                            ...
                            $viajeDelPasajero = $unPasajero->getObjViaje();
